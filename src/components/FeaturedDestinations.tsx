...
const FeaturedDestinations = () => {
  return <section className="liquid-spacing bg-gradient-to-b from-background to-muted/30">
      <div className="liquid-container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          {destinations.map((destination, index) => <div key={destination.id} className="liquid-glass-card rounded-2xl overflow-hidden liquid-ripple group" style={{
          animationDelay: `${index * 0.2}s`
        }}>
              {/* Image */}
              <div className="relative overflow-hidden">
                <img src={destination.image} alt={destination.name} className="w-full h-48 object-cover group-hover:scale-110 transition-transform duration-500" />

...
const Footer = () => {
  ...
  return <footer className="liquid-glass-soft border-t border-border/50">
        ...
        <div className="py-16">
          ...
          <div className="liquid-glass-card p-8 rounded-2xl mb-12">
            <div className="text-center max-w-2xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
                <input type="email" placeholder="Enter your email" className="flex-1 px-4 py-2 liquid-glass rounded-lg border border-border/50 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary/50" />
          ...
          <div className="flex flex-col md:flex-row items-center justify-between pt-8 border-t border-border/50">
            ...
            <div className="flex items-center space-x-4">
              {socialLinks.map((social, index) => <a key={index} href={social.href} aria-label={social.label} className="liquid-glass w-10 h-10 rounded-lg flex items-center justify-center hover:liquid-glass-card transition-all duration-300">
